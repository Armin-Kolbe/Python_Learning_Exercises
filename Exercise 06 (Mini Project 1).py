...
# The data will be stored across three lists: one for task names, one for task statuses, and 
# one for task durations.
...
for i in range(200):
  ...
  # NOTHING : If user entered nothing
  ...
  # ANY THING FALSE : If user type not correct
